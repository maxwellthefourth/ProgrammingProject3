...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/programmingproject3

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/programmingproject3: ../MemorySubsystem/dist/Debug/GNU-Linux/libmemorysubsystem.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/programmingproject3: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/programmingproject3 ${OBJECTFILES} ${LDLIBSOPTIONS}
